/*
  ...
  Created By: Rajan Yadav
  
  Github: https://github.com/rajanydv
  LinkedIn: http://www.linkedin.com/in/yadavrajan
*/
...
void endScreen(){
    ...
    printf("----------------------------------------------\n");
    printf(">>> Creator: Rajan Yadav <<< \n");
    printf("----------------------------------------------\n\n");

    printf("> Github: https://github.com/rajanydv \n");
    printf("> LinkedIn: http://www.linkedin.com/in/yadavrajan \n\n");
